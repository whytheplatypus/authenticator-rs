    ...
    Output: Deserialize<'a>,
{
    from_slice_stream(input)
        // can't use custom errorkind because of error type mismatch in parse
        // _attested_cred_data
                ...
                E: de::Error,
            {
                parse_ad(v)
                    ...
                    .map_err(|e| match e {
                        ...
                        e => E::custom(e.into_error_kind().description().to_string()),
                    })
            }
        }
                ...
                M: MapAccess<'de>,
            {
                ...
                while let Some(key) = map.next_key()? {
                    match key {
                        ...
                        1 => {
                            if format.is_some() {
                                return Err(de::Error::duplicate_field("fmt"));
                            }
